...
kubectl create -f settlement-backend-mock/kubernetes/settlement_backend_mock_deployment.yaml
kubectl create -f settlement-backend-mock/kubernetes/settlement_backend_mock_svc.yaml