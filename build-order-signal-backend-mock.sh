...
kubectl create -f order-signal-backend-mock/kubernetes/order_signal_backend_mock_deployment.yaml
kubectl create -f order-signal-backend-mock/kubernetes/order_signal_backend_mock_svc.yaml